            ...
            <div className="w-5xl mx-auto py-10 px-4">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-8">
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        {/* Title / Alt Text */}
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Image Title / Alt Text</label>
                            <Input
                                type="text"
                                value={data.alt}
                                onChange={e => setData('alt', e.target.value)}
                                className="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 focus:ring-blue-500 focus:border-blue-500"
                            ...
                            <div className={`border-2 border-dashed rounded-xl p-8 text-center transition-colors ${preview ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/10' : 'border-gray-300 hover:bg-gray-50 dark:border-gray-600 dark:hover:bg-gray-700'}`}>
                                ...
                                {preview ? (
                                    ...
                                    <div className="flex flex-col items-center">
                                        ...
                                        <p className="text-xs text-gray-400 mt-2">PNG, JPG , Webp up to 500 kbB</p>
                                    </div>
                                )}
                            </div>
